...
defMultiEp = '''1) Epitope: SequenceROI (Idx: 34-40, ROI: RGVYYPD) (Set 105, Item 2, Name ROI_34-40)
2) Linker: LLLLLL
3) Epitope: SequenceROI (Idx: 70-81, ROI: VSGTNGTKRFDN) (Set 105, Item 4, Name ROI_70-81)
4) Linker: TTTTTTTT
5) Epitope: SequenceROI (Idx: 1-10, ROI: MFVFLVLLPL) (Set 105, Item 1, Name ROI_1-10)
'''
