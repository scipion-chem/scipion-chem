...
class TestScoreDocking(BaseTest):
    @classmethod
    def setUpClass(cls):
    ...
    def _runScoreDocking(self, inputDockProts):
      ...
      self.launchProtocol(protScoreDocks, wait=True)
      self.assertIsNotNone(protScoreDocks.outputSmallMolecules,
                           "There was a problem with the consensus")

    def testScoreDocking(self):
      inputDockProts = []
