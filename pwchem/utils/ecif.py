...
#     with open("temp.pdbqt", "w") as file:
#         file.write(pdbqt)
#
#     # Convert PDBQT to SDF using obabel command-line tool
#     subprocess.run(["obabel", "-ipdbqt", "temp.pdbqt", "-osdf",'-O',"temp.sdf", "-h"], check=True)
#
#     # Read the generated SDF file
#     with open("temp.sdf", "r") as file:
#         outMDL = file.read()
#
#     # Clean up temporary files
#     subprocess.run(["rm", "temp.pdbqt", "temp.sdf"], check=True)
#
#     return outMDL
#
