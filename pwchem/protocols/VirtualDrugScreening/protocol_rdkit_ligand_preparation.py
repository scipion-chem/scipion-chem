...
class ProtChemRDKitPrepareLigands(ProtocolBaseLibraryToSetOfMols):
    ...
    def _defineParams(self, form):
        ...
        group.addParam('removeSalts', params.StringParam, expertLevel=params.LEVEL_ADVANCED,
                       default='', label='Remove salts: ',
                       help='Set the ions you want to remove from the structure, comma separated:'
                            'e.g: Cl,Na')
        ...
        conformers.addParam('restrainMethod', params.EnumParam, choices=CONF_METHODS,
                            default=4, condition="doConformers", label='Method of conformers generation',
    ...
    def writeParamsFile(self, paramsFile, it):
        ...
        with open(paramsFile, 'w') as f:
            ...
            saltList = [salt.strip() for salt in self.removeSalts.get().split(',')]
            f.write(f'removeSalts: {saltList}\n')
